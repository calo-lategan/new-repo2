> **⚠️ ARCHIVED — use v5.** This folder is kept for reference only. The current
> stack is [`custom_sortingv5/`](../custom_sortingv5/) and the v5 installer
> automatically uninstalls v4.1 from your device. Don't install this version
> alongside v5.
