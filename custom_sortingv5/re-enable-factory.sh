#!/usr/bin/env bash
# Re-enable Hiwonder's factory app (start_app_node.service). The v5
...
#
# Note: running v5's launcher again after this will re-disable the
# service. To keep the factory app, do not run launch_v5.sh.
...
echo
echo "Done. v5's launcher will re-disable this on its next run."
