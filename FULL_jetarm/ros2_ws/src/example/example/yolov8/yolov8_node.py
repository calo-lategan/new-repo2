...
class Yolov8Node(Node):
    def __init__(self, name):
        ...
        self.create_service(Trigger, '/yolov8/start', self.start_srv_callback)  # Enter the feature 进入玩法
        self.create_service(Trigger, '/yolov8/stop', self.stop_srv_callback)  # Exit the feature 退出玩法
        ...
        while self.running:
            ...
            try:
                if self.start:
                    ...
                    boxes, scores, classid = self.yolov8_wrapper.infer(result_image, self.conf)
