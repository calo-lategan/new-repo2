...
"QPushButton{border-radius:5px;}")
        ...
        self.widget.setGeometry(QtCore.QRect(350, 110, 220, 160))
...
"border-color: rgb(200, 200, 200);}")
        ...
        self.widget_8.setGeometry(QtCore.QRect(650, 110, 240, 180))
...
"border-color: rgb(200, 200, 200);}")
        ...
        self.widget_9.setGeometry(QtCore.QRect(60, 110, 220, 80))
...
"border-color: rgb(200, 200, 200);}")
        ...
        self.widget_10.setGeometry(QtCore.QRect(60, 230, 220, 80))
...
"QPushButton{border-radius:5px;}")
        ...
        self.label_36.setGeometry(QtCore.QRect(100, 0, 721, 100))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(12)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "BusServo 2.0"))
        ...
        self.label_36.setText(_translate("Form", "<html><head/><body><p><span style=\" color:#aa0000;\">Please note: before adjusting the servo, make sure that the controller is </span></p><p><span style=\" color:#aa0000;\">connected with only one servo, otherwise it may cause a conflicts !!!</span></p><p><span style=\" color:#aa0000;\">注意：本工具的操作会覆盖总线上所有舵机的参数，操作前请确保总线上只连接了一个舵机！！！</span></p></body></html>"))
