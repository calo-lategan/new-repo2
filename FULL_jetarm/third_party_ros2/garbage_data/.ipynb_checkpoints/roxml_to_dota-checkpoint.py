...
if __name__ == '__main__':
    ...
    roxml_path = f'/home/featurize/work/data/Annotations'           # 标注好的xml文件夹
    dotaxml_path = f'/home/featurize/work/data/val_dota'    # 新建文件夹储存
    out_path = f'/home/featurize/work/data/val_original'    # 新建文件夹储存
