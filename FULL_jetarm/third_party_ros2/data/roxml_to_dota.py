...
def edit_xml(xml_file, dotaxml_file):
    ...
    :param dotaxml_file: 生成的dota格式xml文件的路径
    :return: None
    """
...
def rotatePoint(xc, yc, xp, yp, theta):
    """
    将中心点(cx, cy) 和 点 (xp, yp) 绕 (xc, yc) 旋转 theta 角度
    :return: 返回新的点坐标 (x, y)
    """
    xoff = xp - xc
    yoff = yp - yc
...
if __name__ == '__main__':
    ...
    # -----**** 第一步：把xml文件统一转换成旋转框的xml文件 ****    修改为自己的路径-----
    roxml_path = f'/home/ubuntu/third_party_ros2/data/Annotations'           # 标注好的xml文件夹
    dotaxml_path = f'/home/ubuntu/third_party_ros2/data/val_dota'    # 新建文件夹储存
    out_path = f'/home/ubuntu/third_party_ros2/data/val_original'    # 新建文件夹储存
